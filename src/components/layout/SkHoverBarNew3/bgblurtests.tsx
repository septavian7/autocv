...
const HoverBarOuterOuterContainer = styled(motion.div)`
  ...
  background-image: url("https://www.karschofield.com/images/photos/IMG_0607_sm.jpg"); /* Replace with your image URL */
...
const featherMaskSVG = (
  <svg width="100%" height="100%">
    <defs>
      <linearGradient id="featherEffect" gradientTransform="rotate(90)">
...
const HoverBarOuterContainer = styled(motion.div)`
  ...
  mask: url(#maskWithFeather);
  -webkit-mask: url(#maskWithFeather); /* For WebKit browsers */
`;
...
// Interesting blur/gradient effect test
/* const HoverBarOuterContainer = styled(motion.div)`
  position: relative;
  border-radius: 10px;
  display: flex;
  ...
  &::before {
    ...
    left: 0;
    pointer-events: none;
    background: radial-gradient(circle, transparent, rgba(0, 0, 0, 0.7) 70%);
  }
`; */
...
const HoverBarButtonMakeMainText = styled(motion.span)`
  background-color: rgba(255, 255, 255, 0.9);
  padding: 10px 15px;
`;
  ...
  return (
    <div>
      <HoverBarOuterOuterContainer>
        {featherMaskSVG} {/* Render the inline SVG */}
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <HoverBarButtonMakeMainText>X</HoverBarButtonMakeMainText>
              </HoverBarButtonMakeMain>
