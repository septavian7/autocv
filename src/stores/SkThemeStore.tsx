  ...
  get colors() {
    ...
    const themes = {
      ...
      light: {
        ...
        background: 'radial-gradient(circle, rgba(255,255,255,0.7) 0%, rgba(255,255,255,0.6) 100%)', // Light theme general background color
        ...
        // Hover Bar
        hoverBarBackground: 'radial-gradient(circle, rgba(255,255,255,0.7) 0%, rgba(255,255,255,0.6) 100%)', // Light theme hover bar background
      ...
      dark: {
        ...
        background: 'radial-gradient(circle, rgba(55,55,55,0.7) 0%, rgba(55,55,55,0.6) 100%)', // Dark theme general background color
        ...
        // Hover Bar
        hoverBarBackground: 'radial-gradient(circle, rgba(55,55,55,0.7) 0%, rgba(55,55,55,0.6) 100%)', // Dark theme hover bar background
